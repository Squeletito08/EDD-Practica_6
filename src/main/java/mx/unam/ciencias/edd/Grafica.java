...
public class Grafica<T> implements Coleccion<T> {
    ...
    public void bfs(T elemento, AccionVerticeGrafica<T> accion) {
        ...
        recorreGrafica(cola, accion);
    }

    private void recorreGrafica(MeteSaca<Vertice> estructura, AccionVerticeGrafica<T> accion){
        
        if(estructura.esVacia())
            return; 

        Vertice v = estructura.saca(); 
        ...
        recorreGrafica(estructura, accion);
